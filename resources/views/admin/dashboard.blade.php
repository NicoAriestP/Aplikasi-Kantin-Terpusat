...
@section('content')
    ...
    <!-- Main row -->
    <div class="row">
        {{-- GRAFIK PENDAPATAN ALL --}}
        <div class="col-lg-12">
            <button onclick="pilihWarung()" class="btn btn-info btn-xs btn-flat">
                <i class="fa fa-plus-circle"></i>
                Pilih Warung
            </button>
            <div class="box">
                <div class="box-header with-border">
                    <h3 class="box-title">Grafik Pendapatan {{ tanggal_indonesia($tanggalAwal, false) }} s/d
        ...
        $(function() {
            ...
            var salesChartData = {
                ...
                datasets: [{
                    ...
                    data: {{ json_encode($data_pendapatan_all) }}
                }]
            };
