...
@section('title')
    ...
    {{ $namaWarungDipilih != '' ? 'Dari ' . $namaWarungDipilih : '' }}
@endsection
...
@section('content')
            ...
            <div class="box">
                <div class="box-header with-border">
                    <button onclick="updatePeriode()" class="btn btn-info btn-xs btn-flat"><i class="fa fa-plus-circle"></i>
                        Ubah Periode</button>
                    {{-- <button onclick="pilihWarung()" class="btn btn-warning btn-xs btn-flat"><i
                            class="fa fa-plus-circle"></i> Pilih Warung</button> --}}
                    <a href="{{ route('laporan-warung.export_pdf', [$tanggalAwal, $tanggalAkhir, $id_warung]) }}"
    ...
    @includeIf('laporan_warung.form_tanggal')
@endsection
    ...
    <script>
        ...
        $(function() {
            table = $('.table').DataTable({
                ...
                autoWidth: false,
                ajax: {
                    url: '{{ route('laporan-warung.data', [$tanggalAwal, $tanggalAkhir, $id_warung]) }}',
                },
                columns: [{
                        data: 'DT_RowIndex',
                        searchable: false,
        ...
        // function pilihWarung() {
        //     $('#modal-form-warung').modal('show');
        // }
    </script>
@endpush
